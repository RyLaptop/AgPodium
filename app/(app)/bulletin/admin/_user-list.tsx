...
export function UserList({ users }: { users: UserRow[] }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="text-xs text-gray-500">{filtered.length} user{filtered.length === 1 ? "" : "s"}</div>
              ...
              <form ref={formRef} onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  <label className="block">
                    ...
                    <input
                      ...
                      className="mt-0.5 w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-brand"
                    />
                  </label>
                  <label className="block">
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input
                    ...
                    name="is_site_admin"
                    value="true"
                    defaultChecked={u.is_site_admin}
                  />
                  Site admin
                </label>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={pending}
                    className="px-3 py-1 text-sm bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-60"
                  >
                    Yes, delete
                  </button>
                  <button
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex gap-1.5 shrink-0">
                  <button
                    ...
                    className="px-2.5 py-1 text-xs border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-brand"
                  >
                    Edit
                  </button>
                  <button
